...
$(document).bind('toolbar_setup', function() {
	...
	$('<li><a data-link-type="forum" href="https://erpnext.com/docs/user/manual" \
		target="_blank">'+__('Documentation_in_erp_conf')+'</a></li>').insertBefore($help_menu);
	$('<li><a data-link-type="forum" href="https://discuss.erpnext.com" \
		target="_blank">'+__('User Forum_in_erp_conf')+'</a></li>').insertBefore($help_menu);
	$('<li><a href="https://github.com/frappe/erpnext/issues" \
		target="_blank">'+__('Report an Issue_in_erp_conf')+'</a></li>').insertBefore($help_menu);
